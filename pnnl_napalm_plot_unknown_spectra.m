function pnnl_napalm_plot_unknown_spectra
    %pnnl_napalm_plot_unknown_spectra Plot napalm unknown spectra
    ...
    color = colorOrder(5,:);
    clf
    pnnl_strip_plot(Wavenumbers,A_unknown,...
        'Absorbance spectra of unknown data',...
        WavenumberLabel,'A_{unknown}',color);
