function [C_cls, RMSEP_cls, C_cls_train, RMSEC_cls_train, C_cls_cross_validation, RMSECV_cls, data] = pnnl_napalm_cls(varargin)
    %pnnl_napalm_cls Classical Least Squares regression on the napalm data
    %
    %   pnnl_napalm_cls with no output parameters performs classical least
    %   squares (CLS) regression on the napalm data and plots the results.
    %
    %   [C_cls, RMSEP_cls, C_cls_train, RMSEC_cls_train, ...
    %    C_cls_cross_validation, RMSECV_cls, data] = pnnl_napalm_cls
