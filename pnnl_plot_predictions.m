function pnnl_plot_predictions(label_array,ConstituentNames,C_train,C_validation,...
        C_predicted_array,C_predicted_train_array,C_predicted_cross_validation_array, ...
        RMSEP,RMSEC,RMSECV)
    %pnnl_plot_predictions Plot predictions

    % Copyright 2022-2023 Battelle Memorial Institute
    for i = 1:length(label_array)
        pnnl_plot_concentration(label_array{i},ConstituentNames,...
            C_train,C_validation,...
            C_predicted_array(:,:,i),C_predicted_train_array(:,:,i),...
            C_predicted_cross_validation_array(:,:,i));
        pnnl_display_rmse(label_array{i},ConstituentNames,...
            RMSEC(i,:),RMSECV(i,:),RMSEP(i,:));
    end
end
% Reference
%
